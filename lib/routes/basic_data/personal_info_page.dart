...
import 'package:quality_control/routes/basic_data/personal_info_detail_page.dart';
          ...
          Padding(
              ...
              child: Flex(
                ...
                children: const [
                  ...
                  Expanded(flex: 1, child: Text("手机号")),
                  Expanded(
                      flex: 2,
                      child: Text(
                        "身份证号",
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Flex(
          direction: Axis.horizontal,
          children: [
            Expanded(flex: 1, child: Text("用户$index")),
            Expanded(flex: 1, child: Text("手机号$index")),
            Expanded(
                flex: 2,
                child: Text(
                  "身份证号$index",
            ...
            Expanded(
                flex: 1,
                child: Text(
                  Global.dateFormat2.format(DateTime.now()),
                  textAlign: TextAlign.end,
                )),
          ],
        ),
